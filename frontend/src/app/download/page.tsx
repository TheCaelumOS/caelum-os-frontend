        ...
        <div className="rounded-2xl border border-purple-200 bg-gradient-to-b from-purple-50/40 via-white to-white p-8 sm:p-10 shadow-sm relative overflow-hidden">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              <div className="p-3 rounded-lg bg-purple-50/60 border border-purple-100 flex items-start space-x-2.5">
                <ShieldCheck className="w-4 h-4 text-purple-600 flex-shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold text-slate-800 block">Zero Cloud Exposure</span>
                  <span className="text-slate-500 text-[11px]">Binds strictly to loopback IP. Never exposes ports to public internet.</span>
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg bg-purple-50/60 border border-purple-100 flex items-start space-x-2.5">
                <ShieldCheck className="w-4 h-4 text-purple-600 flex-shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold text-slate-800 block">Private Network Access</span>
                  <span className="text-slate-500 text-[11px]">W3C PNA compliant with local pairing token security.</span>
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg bg-purple-50/60 border border-purple-100 flex items-start space-x-2.5">
                <ShieldCheck className="w-4 h-4 text-purple-600 flex-shrink-0 mt-0.5" />
                <div className="text-xs">
                  <span className="font-bold text-slate-800 block">Strict Whitelisting</span>
                  <span className="text-slate-500 text-[11px]">Only safe Docker &amp; Kubernetes read/manage operations allowed.</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
              <Link
                href="/os"
                className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-3 rounded-lg text-sm font-semibold text-white bg-purple-600 hover:bg-purple-700 transition-colors shadow-xs"
              >
                <span>Launch CaelumOS &amp; Pair Infrastructure</span>
              </Link>
              <a
                href="https://github.com/TheCaelumOS/caelum-os-frontend/tree/main/desktop-agent"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 px-6 py-3 rounded-lg text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 border border-slate-300 transition-colors shadow-xs"
              >
                <GithubLogo className="w-4 h-4 text-slate-600" />
                <span>View Agent Source on GitHub</span>
              </a>
            </div>
